...
const EN = {
  ...
  enddate: "End Date",
  editregister: "Edit",
  approveregister: "Approve",
  qrapprove: "Approve",
  qrregistersuccess: "လူကြီးမင်းအားလက်ခံပါသည်",
  pluscase: "Plus Case Report",
  totalpaitent: "Total Paitent Count",
  total: "Total",
...
const MM = {
  ...
  register_user: "လျှောက်လွှာတင်ထားသူ",
  Bhikkhuname: "ဘွဲ့တော်",
  ...
  loginadmin: "ဝင်မည်",
  registeruser: "လျှောက်လွှာတင်ထားသူများ",
  qrscan: "QR Code ဖတ်ရန်",
  startdate: "စရက်",
  enddate: "ဆုံးရက်",
  editregister: "ပြုပြင်ရန်",
  approveregister: "ခွင့်ပြုသည်",
  qrapprove: "လက်ခံသည်",
  qrregistersuccess: "လူကြီးမင်းအားလက်ခံပါသည်",
  pluscase: "အတည်ပြုလူနာ စားရင်း",
  totalpaitent: "လူနာစုစုပေါင်း",
  total: "စုစုပေါင်း",
