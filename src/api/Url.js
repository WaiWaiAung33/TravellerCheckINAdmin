...
export const RegisterHistoryApi = BaseUrl + "travelHistory";
export const EditApi = BaseUrl + "editData";

//get version
export const GetVersionApi = BaseUrl + "forceVersion";

//get travellerhistory
export const TravelHistoryApi = BaseUrl + "travelHistory";

//create register
export const RegisterApi = BaseUrl + "adminRegrister";

//get dashboard
export const DashboardApi = BaseUrl + "pluscase";

//get townshipdetail
export const TownshipDetail = BaseUrl + "pluscasedata";
